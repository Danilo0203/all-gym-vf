      ...
      <Card className='@container/card bg-gradient-to-br from-emerald-500/10 to-emerald-500/5 dark:from-emerald-500/20 dark:to-emerald-500/5 border-emerald-500/20'>
        <CardHeader className='pb-2'>
          ...
          <CardAction>
            <Badge 
              variant='outline' 
              className={data.revenueChange >= 0 
                ? 'border-emerald-500/50 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300' 
                : 'border-red-500/50 bg-red-500/10 text-red-700 dark:text-red-300'
              }
            >
              {data.revenueChange >= 0 ? <IconTrendingUp className='mr-1 h-3 w-3' /> : <IconTrendingDown className='mr-1 h-3 w-3' />}
