...
const customerFormSchema = z.object({
  ...
  height_cm: z.coerce.number({ message: 'La estatura es obligatoria' }).positive({ message: 'La estatura debe ser mayor a 0' }),
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className='sm:max-w-xl w-full flex flex-col h-full p-0 gap-0'>
        ...
        <div className='flex-1 overflow-y-auto px-6 py-6'>
          <Form {...form}>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4 pl-4'>
                <FormInputGroup control={form.control} name='full_name' label='Nombre Completo' placeholder='Nombre Apellido' icon={<IconUser className='h-4 w-4' />} />
                  <FormField
                    control={form.control}
                    name="birth_date"
                    render={({ field }) => (
                  ...
                  />
                <FormInputGroup control={form.control} name='phone' label='Teléfono' placeholder='555-0000' type='tel' icon={<IconPhone className='h-4 w-4' />} />
              </div>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-4 pl-4'>
                <div className='grid grid-cols-2 gap-4'>
                  <FormInputGroup control={form.control} name='weight_kg' label='Peso (kg)' type='number' icon={<IconScale className='h-4 w-4' />} placeholder='70' />
                  <FormInputGroup control={form.control} name='height_cm' label='Estatura (cm)' type='number' icon={<IconRuler className='h-4 w-4' />} placeholder='170' />
                </div>
                <FormSelect
                  control={form.control}
                  name='body_type'
        ...
        <SheetFooter className='flex-shrink-0 border-t px-6 py-4 flex-row gap-2'>
          <SheetClose asChild>
            <Button variant='outline' disabled={isPending} className='flex-1'>Cancelar</Button>
          </SheetClose>
