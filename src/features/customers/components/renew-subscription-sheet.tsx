...
import { IconCalendar, IconDiscount, IconScale, IconRuler, IconCheck, IconLoader2, IconRefresh, IconNotes } from '@tabler/icons-react';
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="sm:max-w-xl overflow-y-auto w-full">
        ...
        <Form {...form}>
          <form className="space-y-6 mt-6 pb-20">
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-lg">Ficha Médica</h3>
              </div>
              <Separator />
            ...
            <SheetFooter className="pt-6">
               <Button type="button" onClick={form.handleSubmit(onSubmit)} disabled={loading} className="w-full bg-emerald-600 hover:bg-emerald-700">
