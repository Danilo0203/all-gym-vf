...
async def run_test():
    async with async_playwright() as p:
        ...
        await page.locator("input[placeholder='0.00']").fill("350")

        await page.get_by_role("combobox").nth(1).click()
        await page.get_by_role("option", name="Transferencia").click()

        await page.get_by_test_id("payments-submit-button").click()
        await expect(page.get_by_text("350").first).to_be_visible(timeout=12000)
        await browser.close()
